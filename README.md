...
1. [JAVA API 서비스 미터링 개발가이드](#3)
    ...
    * [샘플 API 서비스 개발](#7)
     ...
     * [샘플 API 서비스 형상](#9)
     * [의존성 및 프로퍼티의 설정](#10)
     * [MeteringAuthService 클래스](#11)
     * [MeteringService 클래스](#12)
     * [SampleApiJavaServiceController 클래스](#13)
    * [API 서비스 연동 샘플 애플리케이션](#14)
    * [API 서비스 연동 샘플 애플리케이션 인터페이스 항목](#15)
    * [미터링/등급/과금 정책](#16)
     * [미터링 정책](#17)
     * [등급 정책](#18)
     * [과금 정책](#19)
    ...
    * [배포](#21)
     * [파스-타 플랫폼 로그인](#22)
     * [API 서비스 브로커 생성](#23)
     * [API 서비스 애플리케이션 배포 및 서비스 등록](#24)
     * [API 서비스 연동 샘플 애플리케이션 배포 및 서비스 연결](#25)
    * [API 및 CF-Abacus 연동 테스트](#26)
...
| **Gender**                     |       서비스 브로커 API        |     Cloud Controller와 Service Broker 사이의 규약으로써 서비스 브로커 API 개발에 대해서는 다음을 참조한다.<br>
https://github.com/OpenPaaSRnD/Documents/blob/master/Development-Guide/ServicePack_develope_guide.md#11
                            |                                  
| Male (%)                       |        서비스 API             |     서비스 제공자가 제공하는 API 서비스 기능 및 API 사용량을 CF-ABACUS에 전송하는 기능으로 구성되었다.                            |
| Female (%)                     |        대시보드               |     서비스를 제공하기 위한 인증, 서비스 모니터링 등을 위한 대시보드 기능으로 서비스 제공자가 개발해야 한다.                            |
...
###SampleApiJavaServiceController 클래스
...
###API 서비스 연동 샘플 애플리케이션 배포 및 서비스 연결 {.번호대제목-western}
    =====================================================
