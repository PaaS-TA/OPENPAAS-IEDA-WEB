...
###2.4.2. CF 앱 사용량 수집을 위한 UAA 계정 등록
...
##2.4.3.  Secured Abacus를 위한 UAA 계정 등록 
...
###2.6.1. Git을 통해 cf-abacus를 다운 받는다.
...
###2.6.2. Abacus와 연동할 DB 및 Secure 정보 설정
